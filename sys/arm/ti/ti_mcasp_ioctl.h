...
#define MCASP_IOCTL_PIN_MCASP_SET           _IOW(MCASP_IOCTL_MAGIC, 27, uint32_t)
#define MCASP_IOCTL_PIN_GPIO_SET            _IOW(MCASP_IOCTL_MAGIC, 28, uint32_t)
#define MCASP_IOCTL_TX_TIME_SLOT_SET        _IOW(MCASP_IOCTL_MAGIC, 29, uint32_t)
#define MCASP_IOCTL_RX_TIME_SLOT_SET        _IOW(MCASP_IOCTL_MAGIC, 30, uint32_t)
#define MCASP_IOCTL_TX_INT_DISABLE          _IOW(MCASP_IOCTL_MAGIC, 31, uint32_t)
#define MCASP_IOCTL_RX_INT_DISABLE          _IOW(MCASP_IOCTL_MAGIC, 32, uint32_t)
#define MCASP_IOCTL_TX_INT_ENABLE           _IOW(MCASP_IOCTL_MAGIC, 33, uint32_t)
#define MCASP_IOCTL_RX_INT_ENABLE           _IOW(MCASP_IOCTL_MAGIC, 34, uint32_t)
#define MCASP_IOCTL_TX_CLK_START            _IOW(MCASP_IOCTL_MAGIC, 35, uint32_t)
#define MCASP_IOCTL_RX_CLK_START            _IOW(MCASP_IOCTL_MAGIC, 36, uint32_t)
#define MCASP_IOCTL_TX_SER_ACTIVATE         _IO(MCASP_IOCTL_MAGIC, 37)
#define MCASP_IOCTL_RX_SER_ACTIVATE         _IO(MCASP_IOCTL_MAGIC, 38)
#define MCASP_IOCTL_TX_ENABLE               _IO(MCASP_IOCTL_MAGIC, 39)
#define MCASP_IOCTL_RX_ENABLE               _IO(MCASP_IOCTL_MAGIC, 40)
typedef struct {
    uint32_t errFlags;
    uint32_t pinState;
} mcasp_a_mute_enable_t;
#define MCASP_IOCTL_A_MUTE_ENABLE           _IOW(MCASP_IOCTL_MAGIC, 41, mcasp_a_mute_enable_t)
#define MCASP_IOCTL_A_MUTE_DISABLE          _IO(MCASP_IOCTL_MAGIC, 42)
#define MCASP_IOCTL_A_MUTE_IN_ACTIVATE      _IOW(MCASP_IOCTL_MAGIC, 43, uint32_t)
typedef struct {
    uint32_t clkDiv;
    uint8_t boundMin;
    uint8_t boundMax;
...
#define MCASP_IOCTL_DIT_CHAN_STAT_WRITE     _IO(MCASP_IOCTL_MAGIC, 49)
